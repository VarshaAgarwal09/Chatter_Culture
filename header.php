...
echo <<<_MAIN
    <title>Chatter Culture: $userstr</title>
  </head>
  <body>
    <div data-role='page'>
      <div data-role='header'>
        <div id='logo' class='center' align="left"><img src="culture.png" height=150px width=150px; />      Chatter Culture</div>
